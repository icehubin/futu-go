...
const (
	...
	PatternField_PatternField_KDJGoldCrossLow      PatternField = 9  // KDJ低位金叉（D值小于或等于30，且前一日K值小于D值，当日K值大于D值）
	PatternField_PatternField_KDJDeathCrossHigh    PatternField = 10 // KDJ高位死叉（D值大于或等于70，且前一日K值大于D值，当日K值小于D值）
...
type StockData struct {
	...
	CustomIndicatorDataList []*CustomIndicatorData `protobuf:"bytes,6,rep,name=customIndicatorDataList" json:"customIndicatorDataList,omitempty"` // 筛选后的自定义技术指标属性数据
}
...
var file_Qot_StockFilter_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x02, 0x28, 0x05, 0x52, 0x06, 0x6b, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x22, 0x8f, 0x03,
	...
	0x6e, 0x61, 0x6e, 0x63, 0x69, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x12,
	0x5e, 0x0a, 0x17, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x49, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74,
	0x6f, 0x72, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x24, 0x2e, 0x51, 0x6f, 0x74, 0x5f, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x46, 0x69, 0x6c, 0x74,
	0x65, 0x72, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x49, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74,
	0x6f, 0x72, 0x44, 0x61, 0x74, 0x61, 0x52, 0x17, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x49, 0x6e,
	0x64, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x22,
	...
	0x44, 0x69, 0x72, 0x5f, 0x44, 0x65, 0x73, 0x63, 0x65, 0x6e, 0x64, 0x10, 0x02, 0x42, 0x44, 0x0a,
	...
	0x2f, 0x69, 0x63, 0x65, 0x68, 0x75, 0x62, 0x69, 0x6e, 0x2f, 0x66, 0x75, 0x74, 0x75, 0x2d, 0x67,
	0x6f, 0x2f, 0x70, 0x62, 0x2f, 0x71, 0x6f, 0x74, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x66, 0x69, 0x6c,
	0x74, 0x65, 0x72,
}
